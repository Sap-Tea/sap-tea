        ...
        @if($dados)
            ...
            @foreach($results as $perfil)
                ...
                <div class="form-group">
                    ...
                    <textarea rows="3" name="areas_interesse">{{$perfil->livre_gosta_fazer }}</textarea>
                </div>

                <div class="form-group">
                    <label>Gosta de fazer no tempo livre:</label>
                    <textarea rows="3" name="atividades_livre">{{$perfil->feliz_est }}</textarea>
                </div>

                <div class="form-group">
                    <label>Deixa o estudante muito feliz:</label>
                    <textarea rows="3" name="feliz">{{$perfil->feliz_est }}</textarea>
                </div>

                <div class="form-group">
                    <label>Deixa o estudante muito triste ou desconfortável:</label>
                    <textarea rows="3" name="triste">{{$perfil->trist_est }}</textarea>
                </div>

                <div class="form-group">
                    <label>Objeto de apego? Qual?</label>
                    <textarea rows="3" name="objeto_apego">{{$perfil->obj_apego }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="3" name="recomenda_instrucao">{{$perfil->recomenda_instrucao }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="3" name="manejo_sensibilidade">{{$perfil->maneja_04 }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="3" name="alimentos_evita">{{$perfil->alimento_evita_04 }}</textarea>
                </div>
